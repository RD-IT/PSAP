    ...
    class FrmOrganizationStruBLL
    {
        ...
        public static void tvwDepartmentGetNode(TreeView treeV)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                GetChileNode(node1, dr["DepartmentNo"].ToString());
            }
        }
        //生成子部门节点
        private static void GetChileNode(TreeNode node1, string strParentDepartmentNo)
        {
            ...
            foreach (DataRow dr1 in dt1.Rows)
            {
                if (dr1 != null)
                {
                    ...
                    GetChileNode(node2, node2.Name);//递归
                }
            }
        }
