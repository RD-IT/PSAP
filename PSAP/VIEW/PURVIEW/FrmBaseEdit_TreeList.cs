...
{
    public partial class FrmBaseEdit_TreeList : DockContent
    {
        /// <summary>
        /// form的主数据表名
        /// </summary>
        ...
        /// </summary>
        private DevExpress.XtraTreeList.TreeList browseXtraTreeList;
        public DevExpress.XtraTreeList.TreeList BrowseXtraTreeList
        {
            get
            {
                return browseXtraTreeList;
            }
            set
            {
                this.browseXtraTreeList = value;
                if (this.browseXtraTreeList == null)
                {
                    return;
                }
                if (this.DesignMode)
                ...
                this.browseXtraTreeList.BeforeFocusNode += this.XtraGridView_BeforeLeaveRow;
                this.browseXtraTreeList.ShownEditor += this.XtraGridView_ShownEditor;
            }
        }
        ...
        private void btnSaveExcel_Click(object sender, EventArgs e)
        {
            try
            {
                FileHandler.SaveTreeListControlExportToExcel(browseXtraTreeList);
                pnlButton.Focus();
            }
            catch (Exception ex)
            {
        ...
        /// </summary>
        private void XtraGridView_BeforeLeaveRow(object sender, DevExpress.XtraTreeList.BeforeFocusNodeEventArgs e)
        {
            try
            {
                if (masterBindingSource.Current != null)
                {
                    DataRow dr = ((DataRowView)masterBindingSource.Current).Row;
                    if (dr[PrimaryKeyColumn] == e.Node[PrimaryKeyColumn])
                    {
                        if (dr.RowState != DataRowState.Unchanged)
                        {
                            ...
                            {
                                if (!btnSave_Click())
                                    browseXtraTreeList.FocusedNode = e.OldNode;
                            }
                            else
                            {
                                dr.RejectChanges();
        ...
        {
            this.browseXtraTreeList.PostEditor();
        }

        private void XtraGridView_ShownEditor(object sender, EventArgs e)
        {
            (sender as TreeList).ActiveEditor.EditValueChanged += XtraGridView_EditValueChanged;
        }
        ...
        private void Set_EditZone_ControlReadOnly(bool readOnlyState)
        {
            ...
            {
                browseXtraTreeList.OptionsBehavior.Editable = !readOnlyState;
            }
        }
